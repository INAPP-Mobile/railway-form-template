...
- Name: admin.spec.ts >> Form Builder UI >> new form page shows form builder
- Location: admin.spec.ts:52:7
...
Call log:
  ...
  - waiting for locator('#field-builder')
...
- navigation:
  ...
  - link "Logout":
    - /url: /admin/logout
- main:
  - heading "Submissions" [level=1]
  - paragraph: total submissions
  - link "Export CSV":
    - /url: /admin/export
  - textbox "Search submissions..."
```
